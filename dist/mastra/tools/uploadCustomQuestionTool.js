...
export const uploadCustomQuestionTool = createTool({
    ...
    execute: async ({ context }) => {
        return await saveCustomQuestion(context.question, context.answer || '', context.difficulty, context.technologies, context.category);
    },
});
// Function to store custom questions in the database
const saveCustomQuestion = async (question, answer, difficulty, technologies, category) => {
    try {
